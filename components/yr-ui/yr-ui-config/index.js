...
/*
  ...
  目前支持配置的组件：yr-ui-button、yr-ui-icon、yr-ui-text、yr-ui-input、yr-ui-list-cell、yr-ui-section、yr-ui-white-space、yr-ui-wing-blank、yr-ui-number
*/

// 主色，仅适用无法使用css变量控制颜色的组件使用【保持与yr-ui-theme中一致】
const color = {
  primary: '#465CFF',
  success: '#09BE4F',
  warning: '#FFB703',
