...
Component({
  ...
  properties: {
    ...
    //边框颜色，颜色可通过css变量(--yr-ui-color-border)修改
    borderColor: {
      type: String,
      value: ''
    },
  ...
  data: {
    placeholderStyl: '',
    focused: false,
    c_labelSize: (wx.$yrUi && wx.$yrUi.fuiInput.labelSize) || 32,
    c_size: (wx.$yrUi && wx.$yrUi.fuiInput.size) || 32,
    c_labelColor: (wx.$yrUi && wx.$yrUi.fuiInput.labelColor) || '#333',
    c_color: (wx.$yrUi && wx.$yrUi.fuiInput.color) || '#333',
    c_dangerColor: (wx.$yrUi && wx.$yrUi.color.danger) || '#FF2B2B'
  },
  lifetimes: {
    attached: function () {
      this.fieldPlaceholderStyle()
