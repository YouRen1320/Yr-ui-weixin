...
Page({
  data: {
    ...
    logList: {
      'V1.0.0': [
        'Yr-ui 正式上线，本次更新如下：',
        '新增 Color 色彩，Yr-ui用色指南',
        '新增 Icon 图标组件，Yr-ui字体图标库',
        '新增 Button 按钮组件',
        '新增 Footer 页脚组件',
        '新增 Animation 动画组件',
        '新增 StatusBar 状态栏占位组件',
        '新增 Layout 栅格布局组件（yr-ui-row和yr-ui-col）',
        '新增 Grid 宫格组件（yr-ui-grid和yr-ui-grid-item）',
        '新增 List 列表组件（yr-ui-list和yr-ui-list-cell）',
        '新增 Card 卡片组件',
        '新增 Input 输入框组件',
      ...
      'V1.1.0': [
        ...
        '新增 Avatar 头像 组件',
        '新增 Form 表单校验 组件',
        '新增 Validator 表单验证（JS）组件',
        '新增 SingleInput 单输入框 组件',
        '新增 IndexList 索引列表 组件',
        '新增 SearchBar 搜索栏 组件',
        '新增 登录（A）模板（物料）',
        '新增 登录（B）模板（物料）',
        '新增 登录（C）模板（物料）',
      ...
      'V1.2.0': [
        ...
        '新增 Progress 进度条 组件',
        '新增 Collapse 折叠面板 组件',
        '新增 SwiperDot 轮播图指示点 组件',
        '新增 DigitalRoller 数字滚轮 组件',
        '新增 DigitalKeyboard 数字键盘 组件',
        '新增 LicensePlate 车牌号键盘 组件',
        '新增 CountdownVerify 验证码倒计时 组件',
        '新增 Sticky 吸顶容器 组件',
        '新增 Fab 浮动按钮 组件',
        '新增 ShareSheet  分享面板 组件',
        '新增 FilterBar 筛选栏 组件',
        '新增 SwipeAction 滑动菜单 组件',
        '新增 Picker 选择器 组件',
        '新增 DatePicker 日期时间选择器 组件',
        '新增 门户模板（物料）',
      ...
      'V1.3.0': [
        ...
        '新增 Gallery 画廊 组件',
        '新增 BubbleBox 气泡框 组件',
        '新增 BottomNavbar 底部导航栏 组件',
        '新增 CountDown 倒计时 组件',
        '新增 CopyText 长按复制 组件',
        '新增 Timer 计时器 组件',
        '新增 Qrcode 二维码 组件',
        '新增 Barcode 条形码 组件',
        '新增 Autograph 手写签名 组件',
      ...
      'V1.4.0': [
        '新增 Circle 圆形进度条 组件',
        '新增 Skeleton 骨架屏 组件',
        '新增 CubicBezier 贝塞尔曲线 组件',
        '新增 SlideVerify 滑动验证 组件',
        '新增 RotateVerify 旋转验证 组件',
        '新增 SliderCaptcha 滑块拼图验证 组件',
        '新增 OverflowHidden 内容超出隐藏 组件',
        '新增 Backtop 回到顶部 组件',
        '新增 Lazyload 图片懒加载 组件',
        '新增 Waterfall 瀑布流 组件',
      ...
      'V1.5.0': [
        '新增 Vtabs 纵向选项卡 组件',
        '新增 PuzzleVerify 滑块拼图验证 组件，此组件为 SliderCaptcha 滑块拼图验证 组件的功能补充。[详见](https://forum.yr-ui.cn/d/48)',
        '新增 Drag 拖拽排序 组件',
        '新增 ImageCropper 图片裁剪 组件',
        '新增 Table 表格 组件',
      ...
      'V1.6.0': [
        '新增 Text 文本组件',
        '新增 spin 旋转动画组件',
        '新增 SafeArea 底部安全区域组件',
        '新增 DataTag 标签选择组件',
        '新增 SubmitBar 提交订单栏 布局内容',
        '新增 GoodsBar 商品导航栏 布局内容',
        '新增 ChatBar 聊天栏 布局内容',
        '新增 RollNews 滚动消息 布局内容',
        '新增 CardSwiper 卡片轮播 布局内容',
      ...
      'V1.9.5': [
        ...
        'Grid 宫格 组件优化，item项（yr-ui-grid-item）新增click事件，原yr-ui-grid组件事件不变',
      ...
      'V1.9.8': [
        ...
        'Rate 评分 组件优化，优化组件嵌套在 Drawer 抽屉 组件中使用时距离计算错误的问题，当使用非yr-ui 抽屉组件时需调用setParentWidth方法修正，详见文档',
        'Picker 选择器 组件优化，修复已知问题',
        'DatePicker 日期时间选择器 组件优化，修复已知问题',
        ...
        'Calendar 日历 组件优化，主色默认使用 yr-ui-config 中配置的颜色',
        'Circle 圆形进度条 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'DataTag 标签选择组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'Dialog 对话框 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'FormItem 表单项组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'Input 输入框 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'Rate 评分 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'RotateVerify 旋转验证 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'SwipeAction 滑动菜单 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
        'UploadVideo 视频上传 组件优化，主色默认使用全局配置（yr-ui-config）颜色',
      ...
      'V1.9.9': [
        ...
        'Layout 栅格布局 组件（yr-ui-row）组件优化，调整部分样式',
      ...
      'V2.2.0': [
        ...
        'Icon 图标 组件优化，调整部分逻辑',
        'Tabbar 标签栏 组件优化，内置 yr-ui-icon 图标组件，支持使用字体图标代替图片图标',
  ...
  onLoad: function (e) {
    let version = e.version || 'V1.0.0'
    this.setData({
      date: e.date || '2021-07-26',
      version: version,
      logs: this.data.logList[version] || ['开发中~']
    })
  }
})